...
public class ReceiptsRecord extends UpdatableRecordImpl<ReceiptsRecord> implements Record6<Integer, Time, String, BigDecimal, Integer, String> {
	...
	private static final long serialVersionUID = 792872065;
	 ...
	 */
	public ReceiptsRecord(Integer id, Time uploaded, String merchant, BigDecimal amount, Integer receiptType, String tag) {
		super(Receipts.RECEIPTS);
